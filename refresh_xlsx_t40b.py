...
# пока некогда исправлять. Проект уж очень узконаправленный и разовый.
# может когда будет время...
# TO DO: убрать if true, пересортировать функции. Меньше объема, больше функционала, одна функция для одного результата, внести все в кострукцию if __name__
